...
export default function NestApp() {
  ...
  return (
    <div style={{ width: "100%", minHeight: "100vh", background: PALETTE.bgDeep, fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ width: "100%", maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: PALETTE.bgDeep, overflow: "hidden", position: "relative", display: "flex", flexDirection: "column", border: `2px solid ${PALETTE.amber}88`, borderRadius: 24 }}>
        {debugMsg && (
